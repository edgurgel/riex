defmodule Riex.CRDT.Counter do
  @moduledoc """
  ...
  """
  def increment(counter, amount \\ 1) when Record.record?(counter, :counter) do
  ...
  """
  def decrement(counter, amount \\ 1) when Record.record?(counter, :counter) do
    :riakc_counter.increment(-amount, counter)
  end
  ...
  """
  def value(counter) when Record.record?(counter, :counter) do
